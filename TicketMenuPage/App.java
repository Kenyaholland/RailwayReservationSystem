...
public class App extends Application {
    ...
    public void start(Stage screen) throws Exception {
        ...
        ticketScene = new Scene(layoutTicket, 900, 500);
        ...
        ticketConfirmationScene = new Scene(layoutTicketConfirmation, 900, 500);
